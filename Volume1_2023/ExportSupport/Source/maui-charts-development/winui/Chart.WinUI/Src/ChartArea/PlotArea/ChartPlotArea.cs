...
namespace Syncfusion.UI.Xaml.Charts
{
    internal class ChartPlotArea : Grid, IPlotArea
    {
        ...
        internal void BindLegendItemProperties(LegendItem legendItem, ChartSeries series, ChartSegment segment = null)
        {
            ...
            SetBinding(legendItem, LegendItem.StrokeProperty, series, new PropertyPath(nameof(series.Stroke)));
            SetBinding(legendItem, LegendItem.StrokeThicknessProperty, series, new PropertyPath(nameof(series.StrokeThickness)));
