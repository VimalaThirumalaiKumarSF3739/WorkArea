...
namespace Syncfusion.UI.Xaml.Charts
{
    ...
    public class DataPointSelectionBehavior : ChartSelectionBehavior
    {
        ...
        {
            if (Series.ActualArea.GetEnableSeriesSelection() || series != Series) return;

            Chart.CurrentSelectedSeries = series;

            var chartDataPointInfo = value as ChartDataPointInfo;
            
            if (Chart.CurrentSelectedSeries is ISegmentSelectable && Chart.CurrentSelectedSeries.GetEnableSegmentSelection()
                && ((value != null && value.GetType() == typeof(int)) || chartDataPointInfo != null))
            {
                ...
                int oldIndex = (Chart.CurrentSelectedSeries as ISegmentSelectable).SelectionBehavior.SelectedIndex;
                ...
                if (!isCancel)
                {
                    ...
                    {
                        ISegmentSelectable currentSelectedSeries = (Chart.CurrentSelectedSeries as ISegmentSelectable);
