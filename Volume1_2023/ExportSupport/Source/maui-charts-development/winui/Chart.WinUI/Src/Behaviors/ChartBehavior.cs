                                              ...
                                              ChartBehavior behavior)
        {
            ...
            if (!chartAxis.IsVertical)
            {
                ...
                if (chartAxis.OpposedPosition)
                {
                    ...
                    if (((control.Content as ChartPointInfo).X - control.DesiredSize.Height <= Chart.SeriesClipRect.X))
                    {
                        ...
                        tipPosition = (control.Content as ChartPointInfo).BaseX - Chart.SeriesClipRect.X;
            ...
            else
            {
                if (chartAxis.OpposedPosition)
                {
                    ...
                    if (((control.Content as ChartPointInfo).Y - control.DesiredSize.Height <= Chart.SeriesClipRect.Y))
                    {
                        if (isChartTrackBallBehavior)
                            AlignDefaultLabel(
                                ChartAlignment.Far,
                        ...
                        double tipPosition = (control.Content as ChartPointInfo).BaseY - Chart.SeriesClipRect.Y;
