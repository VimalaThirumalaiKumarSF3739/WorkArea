...
namespace Syncfusion.UI.Xaml.Charts
{
    ...
    public class LabelBackgroundConverter : IValueConverter
    {
         ...
         public object Convert(object value, Type targetType, object parameter, string language)
        {
            ...
            else if (IsAdornmentSelected(adornment) && adornment.Series is ISegmentSelectable selectable && selectable.SelectionBehavior != null)
                return selectable.SelectionBehavior.SelectionBrush;
        ...
        private static bool IsAdornmentSelected(ChartDataLabel adornment)
        {
            return adornment.Series.SelectedSegmentsIndexes.Contains(adornment.Series.ActualData.IndexOf(adornment.Item))
                   && adornment.Series is ISegmentSelectable selectable && adornment.Series.adornmentInfo.HighlightOnSelection
                   && selectable.SelectionBehavior != null && selectable.SelectionBehavior.SelectionBrush != null
                   && (adornment.Series.adornmentInfo.UseSeriesPalette || adornment.Background != null);
        }
    ...
    public class LabelBorderBrushConverter : IValueConverter
    {
         ...
         public object Convert(object value, Type targetType, object parameter, string language)
        {
            ...
            if (area.SelectedSeriesCollection.Contains(series)
               ...
               && selectableSegment.SelectionBehavior != null
               && selectableSegment.SelectionBehavior.SelectionBrush != null)
                return selectableSegment.SelectionBehavior.SelectionBrush;
            else
