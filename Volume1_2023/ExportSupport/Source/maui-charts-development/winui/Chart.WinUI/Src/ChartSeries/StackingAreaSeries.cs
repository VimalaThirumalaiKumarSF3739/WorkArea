...
namespace Syncfusion.UI.Xaml.Charts
{
    ...
    /// 
    /// <para>It provides options for <see cref="ChartSeries.Fill"/>, <see cref="ChartSeries.PaletteBrushes"/>, <see cref="ChartSeries.Stroke"/>, <see cref="ChartSeries.StrokeThickness"/>, and opacity to customize the appearance.</para>
    /// 
    ...
    public class StackedAreaSeries : StackedSeriesBase, ISegmentSelectable
    {
        ...
        /// <summary>
        /// Gets or sets a selection behavior that enables you to select or highlight a data point in a series.
        /// </summary>
        ...
        ///
        /// <remarks>
        /// <para>To highlight the selected data point, set the value for <see cref="ChartSelectionBehavior.SelectionBrush"/> property in <see cref="DataPointSelectionBehavior"/> class.</para>
        /// </remarks>
        /// <example>
        /// # [Xaml](#tab/tabid-4)
        /// <code><![CDATA[
        ...
        ///                                   XBindingPath="XValue"
        ///                                   YBindingPath="YValue">
        ///              <chart:StackedAreaSeries.SelectionBehavior>
        ...
        /// <remarks>To highlight the close path, set the Stroke and StrokeThickness properties in the series class.</remarks>
        /// <example>
        /// # [Xaml](#tab/tabid-6)
        /// <code><![CDATA[
        ///     <chart:SfCartesianChart>
