...
namespace Syncfusion.UI.Xaml.Charts
{
    ...
    public class StackedColumnSeries : StackedSeriesBase, ISegmentSelectable, ISegmentSpacing
    {
        ...
        ///
        /// <remarks>
        /// <para>To highlight the selected segment, set the value for <see cref="ChartSelectionBehavior.SelectionBrush"/> property in <see cref="DataPointSelectionBehavior"/> class.</para>
        /// </remarks>
        /// <example>
        /// # [Xaml](#tab/tabid-4)
        /// <code><![CDATA[
        ...
        ///                                     XBindingPath="XValue"
        ///                                     YBindingPath="YValue">
        ///              <chart:StackedColumnSeries.SelectionBehavior>
