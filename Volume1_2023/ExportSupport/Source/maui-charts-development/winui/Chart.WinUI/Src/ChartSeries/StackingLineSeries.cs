...
namespace Syncfusion.UI.Xaml.Charts
{
    ...
    /// 
    /// <para>It provides options for <see cref="ChartSeries.Fill"/>, <see cref="ChartSeries.PaletteBrushes"/>, <see cref="StrokeDashArray"/>, <see cref="ChartSeries.StrokeThickness"/>, and opacity to customize the appearance.</para>
    /// 
    ...
    public class StackedLineSeries : StackedSeriesBase, ISegmentSelectable
    {
        ...
        ///                                   XBindingPath="XValue"
        ///                                   YBindingPath="YValue">
        ///              <chart:StackedLineSeries.SelectionBehavior>
