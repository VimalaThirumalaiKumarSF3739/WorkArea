...
namespace Syncfusion.UI.Xaml.Charts
{
    ...
    /// 
    /// <para>It provides options for <see cref="ChartSeries.Fill"/>, <see cref="ChartSeries.PaletteBrushes"/>, <see cref="StackedLineSeries.StrokeDashArray"/>, <see cref="ChartSeries.StrokeThickness"/>, and opacity to customize the appearance.</para>
    /// 
