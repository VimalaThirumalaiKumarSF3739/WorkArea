...
namespace Syncfusion.UI.Xaml.Charts
{
    ...
    public class AreaSeries : XyDataSeries, ISegmentSelectable
    {
        ...
        ///
        /// <remarks>
        /// <para>To highlight the selected data point, set the value for the <see cref="ChartSelectionBehavior.SelectionBrush"/> property in <see cref="DataPointSelectionBehavior"/> class.</para>
        /// </remarks>
        /// <example>
        /// # [Xaml](#tab/tabid-4)
        /// <code><![CDATA[
        ...
        ///                            XBindingPath="XValue"
        ///                            YBindingPath="YValue">
        ///              <chart:AreaSeries.SelectionBehavior>
