...
namespace Syncfusion.UI.Xaml.Charts
{
    ...
    /// 
    /// <para>It provides options for <see cref="ChartSeries.Fill"/>, <see cref="ChartSeries.PaletteBrushes"/>, <see cref="ChartSeries.StrokeThickness"/>, <see cref="FastLineBitmapSeries.StrokeDashArray"/>, and opacity to customize the appearance.</para>
    /// 
