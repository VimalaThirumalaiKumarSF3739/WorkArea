...
namespace Syncfusion.UI.Xaml.Charts
{
    ...
    public abstract class CircularSeries : DataMarkerSeries
    {
        ...
        public static readonly DependencyProperty ExplodeIndexProperty =
            DependencyProperty.Register(nameof(ExplodeIndex), typeof(int), typeof(CircularSeries),
        ...
        public static readonly DependencyProperty ExplodeAllProperty =
            DependencyProperty.Register(nameof(ExplodeAll), typeof(bool), typeof(CircularSeries),
        ...
        public static readonly DependencyProperty ExplodeOnTapProperty =
            DependencyProperty.Register(nameof(ExplodeOnTap), typeof(bool), typeof(CircularSeries),
