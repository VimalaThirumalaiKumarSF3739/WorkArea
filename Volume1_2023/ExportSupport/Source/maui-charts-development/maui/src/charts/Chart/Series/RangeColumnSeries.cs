...
{
    /// <summary>
    /// The <see cref="RangeColumnSeries"/> displays a set of vertical range bars for the given data point values.
    /// </summary>
    /// <remarks>
    ...
    /// <para> Range column series do not yet support trackball behaviour.</para>
    /// </remarks>
    /// <example>
    /// # [Xaml](#tab/tabid-1)
    /// <code><![CDATA[
    ...
    public class RangeColumnSeries : RangeSeriesBase
    {
        ...
        /// </summary>
        ///  <value>It accepts <see cref="Microsoft.Maui.CornerRadius"/> value, the default value is null</value>
        /// <example>
        /// # [Xaml](#tab/tabid-4)
        /// <code><![CDATA[
        ///     <chart:SfCartesianChart>
        ...
        /// <summary>
        /// Gets or sets a value to change the width of the segments.
        /// </summary>
        ...
        internal override DataTemplate? GetDefaultTooltipTemplate(TooltipInfo info)
        {
            ...
            DataTemplate template = new DataTemplate(() =>
            {
                ...
                grid.Add(TooltipContent(texts[0], texts[1], info), 0, 1);
        ...
        private StackLayout TooltipContent(string highValue,string lowValue, TooltipInfo info)
        {
