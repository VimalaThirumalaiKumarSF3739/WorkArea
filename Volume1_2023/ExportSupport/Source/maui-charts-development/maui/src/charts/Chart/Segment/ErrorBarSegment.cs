            ...
            if (errorBarSeries != null)
            {
                ...
                for (int i = 0; i < index; i++)
                {
                    float horCapLinesize = errorBarSeries.HorizontalCapLineStyle != null
                        ? (float)(2 * XRange.Delta * errorBarSeries.HorizontalCapLineStyle.CapLineSize) : (float)(2 * XRange.Delta);
                    float verLineCapSize = errorBarSeries.VerticalCapLineStyle != null
                        ? (float)(0.02 * YRange.Delta * errorBarSeries.VerticalCapLineStyle.CapLineSize) : (float)(0.02 * YRange.Delta);
