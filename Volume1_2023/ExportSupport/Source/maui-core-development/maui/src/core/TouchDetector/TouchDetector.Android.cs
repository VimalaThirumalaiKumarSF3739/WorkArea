        ...
        internal void OnTouch(object? sender, View.TouchEventArgs e)
        {
            ...
            switch (motionEvent.ActionMasked)
            {
                ...
                case MotionEventActions.PointerDown:
                    OnTouchAction(pointerId, PointerActions.Pressed, point);
                    break;
                case MotionEventActions.Move:
                    OnTouchAction(pointerId, PointerActions.Moved, point);
                    break;
                case MotionEventActions.Up:
                case MotionEventActions.Pointer1Up:
                    OnTouchAction(pointerId, PointerActions.Released, point);
                    break;
                case MotionEventActions.Cancel:
                    OnTouchAction(pointerId, PointerActions.Cancelled, point);
                    break;
            }
        }
    }
