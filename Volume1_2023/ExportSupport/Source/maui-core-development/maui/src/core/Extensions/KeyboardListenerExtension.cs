...
namespace Syncfusion.Maui.Core.Internals
{
    ...
    public static class KeyboardListenerExtension
    {
        ...
        internal static bool HandleKeyPress(this View target, NSSet<UIPress> presses, UIPressesEvent evt)
        {
            ...
            if (keyboardDetector != null)
            {
                return keyboardDetector.HandleKeyActions(presses, evt, true);
            }
        ...
        internal static bool HandleKeyRelease(this View target, NSSet<UIPress> presses, UIPressesEvent evt)
        {
            ...
            if (keyboardDetector != null)
            {
                return keyboardDetector.HandleKeyActions(presses, evt, false);
            }
        ...
        /// <summary>
        /// Helper method to identify whether the Control key is pressed.
        /// </summary>
        /// <returns>Returns true if control key is pressed otherwise false.</returns>
        ...
        /// <summary>
        /// Helper method to identify whether the Alt key is pressed.
        /// </summary>
        /// <returns>Returns true if alt key is pressed otherwise false.</returns>
