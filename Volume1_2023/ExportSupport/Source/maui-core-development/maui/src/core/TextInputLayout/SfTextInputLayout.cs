...
namespace Syncfusion.Maui.Core
{
    ...
    public class SfTextInputLayout : SfContentView, ITouchListener
    {
        ...
        public static readonly BindableProperty ContainerTypeProperty =
            BindableProperty.Create(nameof(ContainerType), typeof(ContainerType), typeof(SfTextInputLayout), ContainerType.Filled, BindingMode.Default, null, OnPropertyChanged);
        ...
        {
            get { return this.IsOutlined ? OutlinedPadding + (FloatedHintSize.Height / 2) : this.IsFilled ? FilledTopPadding : NoneTopPadding; }         
        }
        ...
        private double BottomPadding
        {
            get
            {
                return (this.IsFilled ? FilledBottomPadding
                    : this.IsOutlined ? OutlinedPadding : NoneBottomPadding) + (ReserveSpaceForAssistiveLabels? string.IsNullOrEmpty(this.HelperText)? ErrorTextSize.Height : HelperTextSize.Height + DefaultAssistiveLabelPadding :0);
            }
        }
        ...
        private double AssistiveLabelPadding
        {
            get
            {
                return this.ReserveSpaceForAssistiveLabels ? DefaultAssistiveLabelPadding : BaseLineMaxHeight;
            }
        }
        ...
        void ITouchListener.OnTouch(PointerEventArgs e)
        {
            ...
            if (e.Action == PointerActions.Released)
            {
                ...
                // In android the control does not focus when touch the outside of the content region
                // so here we call focus mannually.
                if (this.Content != null && DeviceInfo.Platform == DevicePlatform.Android)
                {
        ...
        {
            return (this.IsFilled ? DefaultAssistiveTextHeight : DefaultAssistiveTextHeight / 2) + ((DeviceInfo.Platform != DevicePlatform.WinUI)? this.BaseLineMaxHeight : 0);
        }

        private double GetDefaultBottomPadding()
        {
            return (this.ReserveSpaceForAssistiveLabels ? DefaultAssistiveLabelPadding + DefaultAssistiveTextHeight : ((DeviceInfo.Platform != DevicePlatform.WinUI) ? this.BaseLineMaxHeight : 0));
        }
        ...
        protected override void OnContentChanged(object oldValue, object newValue)
        {
            ...
            if(newValue is Entry entryContent)
            {
                entryContent.Opacity = IsHintFloated ? 1 : (DeviceInfo.Platform == DevicePlatform.iOS || DeviceInfo.Platform == DevicePlatform.macOS) ? 0.2 : 0;
            }

            if (newValue is Editor editorContent)
            {
                editorContent.Opacity = IsHintFloated ? 1 : (DeviceInfo.Platform == DevicePlatform.iOS || DeviceInfo.Platform == DevicePlatform.macOS) ? 0.2 : 0;
            }
        ...
        private static void OnIsHintFloatedPropertyChanged(BindableObject bindable, object oldValue, object newValue)
        {
            ...
            {
                if(newValue is bool value && inputLayout.Content != null)
                {
                    inputLayout.Content.Opacity = value ? 1 : (DeviceInfo.Platform == DevicePlatform.iOS || DeviceInfo.Platform == DevicePlatform.macOS)? 0.2 : 0;
                }
            }
        }
        ...
        {
            return this.ReserveSpaceForAssistiveLabels ? (int)-(this.HelperTextSize.Height + DefaultAssistiveLabelPadding - this.BaseLineMaxHeight) : 0;       
        }
        ...
        private void UpdateLeadingViewPosition()
        {
            ...
            {
                this.viewBounds.X = (float)(this.leadingViewLeftPadding + this.BaseLineMaxHeight);
                ...
                this.viewBounds.Height = (float)(this.Height - this.AssistiveLabelPadding - this.HelperTextSize.Height);
        ...
        private void UpdateNoneContainerHintPosition()
        {
            ...
            {
                this.hintRect.X = 0;
                this.hintRect.Y = (int)(this.Height - this.HintSize.Height - this.BaseLineMaxHeight -  this.AssistiveLabelPadding - this.HelperTextSize.Height);
        ...
        private void UpdateFilledContainerHintPosition()
        {
            ...
            {
                this.hintRect.X = (float)(StartX + DefaultAssistiveLabelPadding);
                this.hintRect.Y = (float)((this.Height - HelperTextSize.Height - AssistiveLabelPadding) / 2) - (HintSize.Height/2);
                this.hintRect.Width = this.HintSize.Width;
                this.hintRect.Height = this.HintSize.Height;
            }
        }
        ...
        private void UpdateHelperTextPosition()
        {
            ...
            this.helperTextRect.Y = (int) (this.Height - HelperTextSize.Height);           
        ...
        private void UpdateErrorTextPosition()
        {
            ...
            this.errorTextRect.Y = (int) ((this.Height) - ErrorTextSize.Height);
        ...
        private void UpdateBaseLinePoints()
        {
            ...
            this.startPoint.Y = (float)(this.Height - this.HelperTextSize.Height - AssistiveLabelPadding);
            this.endPoint.X = (float)(this.Width - this.trailViewWidth);
            this.endPoint.Y = (float)(this.Height - this.HelperTextSize.Height - AssistiveLabelPadding);
        }
        ...
        private void UpdateOutlineRectF()
        {
            ...
            this.outlineRectF.Height = (float)(this.Height - this.outlineRectF.Y - this.HelperTextSize.Height -  AssistiveLabelPadding);
        }
        ...
        private void UpdateBackgroundRectF()
        {
            ...
            this.backgroundRectF.Height = (float)(this.Height - this.HelperTextSize.Height - this.AssistiveLabelPadding);
        }
        ...
        private void UpdatePrimaryIconRectF()
        {
            ...
            {
                this.primaryIconRectF.Y = (float)(((this.Height - this.AssistiveLabelPadding - this.HelperTextSize.Height) / 2) - (IconSize / 2));
            }
        ...
        private void UpdateStartAndEndValue()
        {
            if (this.IsNone && (this.Width > 0 && this.Height > 0))
            {
                if (this.IsHintFloated)
                {
                    ...
                    this.translateEnd = this.Height - this.HintSize.Height - this.BaseLineMaxHeight - this.AssistiveLabelPadding - this.HelperTextSize.Height - DefaultAssistiveLabelPadding;
                }
                else
                {
                    this.translateStart = this.Height - this.HintSize.Height - this.BaseLineMaxHeight - this.AssistiveLabelPadding - this.HelperTextSize.Height - DefaultAssistiveLabelPadding;
            ...
            if (this.IsFilled && (this.Width > 0 && this.Height > 0))
            {
                if (this.IsHintFloated)
                {
                    ...
                    this.translateEnd = ((this.Height - HelperTextSize.Height - this.AssistiveLabelPadding)/2) - (HintSize.Height / 2);
                }
                else
                {
                    this.translateStart = ((this.Height - HelperTextSize.Height - this.AssistiveLabelPadding)/2) - (HintSize.Height / 2);
