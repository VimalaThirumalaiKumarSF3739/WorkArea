...
namespace Syncfusion.Maui.Core
{
    ...
    public class SfEffectsView : SfContentView, ITouchListener, ITapGestureListener, ILongPressGestureListener
    {
	...
	/// <value>
        ...
        public void Reset()
        {
            ...
            {
                this.rippleEffectLayer.CanRemoveRippleAnimation = this.AnimationIsRunning("RippleAnimator");
            ...
            if (!this.ShouldIgnoreTouches && e != null)
            {
                ...
                if (e.Action == PointerActions.Released)
                {
                    ...
                    else if (this.AutoResetEffects == AutoResetEffects.None)
                    {
                        ...
                        {
                            this.highlightEffectLayer?.UpdateHighlightBounds();
                            if ((this.rippleEffectLayer != null && !this.AnimationIsRunning("RippleAnimator")) || (this.rippleEffectLayer == null && (this.TouchUpEffects.GetAllItems().Contains(SfEffects.None) || this.TouchUpEffects.GetAllItems().Contains(SfEffects.Highlight)) && (this.LongPressEffects.GetAllItems().Contains(SfEffects.None) || !this.LongPressHandled || this.LongPressEffects.GetAllItems().Contains(SfEffects.Highlight))))
                            {
                        ...
                        {
                            AnimationExtensions.Animate(this, this.highlightAnimation, this.OnHighlightAnimationUpdate, 16, 250, Easing.Linear, this.OnAnimationFinished, null);
                        }

                        if ((this.TouchUpEffects != SfEffects.Ripple || !this.TouchUpEffects.GetAllItems().Contains(SfEffects.Ripple)) && this.rippleEffectLayer != null && !this.AnimationIsRunning("RippleAnimator"))
                        {
        ...
        protected override void OnDraw(ICanvas canvas, RectF dirtyRect)
        {
            ...
            this.highlightEffectLayer?.DrawHighlight(canvas);
            this.rippleEffectLayer?.DrawRipple(canvas, dirtyRect);
            this.selectionEffectLayer?.DrawSelection(canvas);
        }
        ...
        protected override Size ArrangeContent(Rect bounds)
        {
            if (bounds.Width > 0 && bounds.Height > 0)
            {
                if (this.highlightEffectLayer != null)
                {
                    this.highlightEffectLayer.Width = bounds.Width;
                    this.highlightEffectLayer.Height = bounds.Height;
                }

                if (this.rippleEffectLayer != null)
                {
                    this.rippleEffectLayer.Width = bounds.Width;
                    this.rippleEffectLayer.Height = bounds.Height;
                }

                if (this.selectionEffectLayer != null)
                {
                    this.selectionEffectLayer.Width = bounds.Width;
                    this.selectionEffectLayer.Height = bounds.Height;
                    if (this.IsSelected)
                    {
        ...
        private void InitializeEffects()
        {
            ...
            this.rippleEffectLayer ??= new RippleEffectLayer(this.RippleBackground, this.RippleAnimationDuration,this,this);
            if(selectionEffectLayer==null)
                this.selectionEffectLayer = new SelectionEffectLayer(this.SelectionBackground,this);
            if(highlightEffectLayer==null)
                this.highlightEffectLayer = new HighlightEffectLayer(this.HighlightBackground,this);
        ...
        private void StartRotationAnimation()
        {
            if (this.Content != null)
            {
                ...
                {
                    this.Content.Rotation = -this.Content.Rotation;
        ...
        private void OnRotationAnimationEnd(double value, bool finished)
        {
            ...
            if ((this.rippleEffectLayer != null && !this.AnimationIsRunning("RippleAnimator")) || (this.rippleEffectLayer == null && (this.TouchUpEffects.GetAllItems().Contains(SfEffects.None) || this.TouchUpEffects.GetAllItems().Contains(SfEffects.Rotation)) && (this.LongPressEffects.GetAllItems().Contains(SfEffects.None) || !this.LongPressHandled || this.LongPressEffects.GetAllItems().Contains(SfEffects.Rotation))))
            {
                this.InvokeAnimationCompletedEvent();
            }
        }
        ...
        private void OnScaleAnimationEnd(double value, bool finished)
        {
            ...
            if ((this.rippleEffectLayer != null && !this.AnimationIsRunning("RippleAnimator")) || (this.rippleEffectLayer == null && (this.TouchUpEffects.GetAllItems().Contains(SfEffects.None) || this.TouchUpEffects.GetAllItems().Contains(SfEffects.Scale)) && (this.LongPressEffects.GetAllItems().Contains(SfEffects.None) || !this.LongPressHandled || this.LongPressEffects.GetAllItems().Contains(SfEffects.Scale))))
            {
                this.InvokeAnimationCompletedEvent();
            }
        }
