...
namespace Syncfusion.Maui.Core
{
    ...
    internal class RippleEffectLayer 
    {
        ...
        private bool isEffectsRenderer = false;
        private double effectsRendererWidth;
        private double effectsRendererHeight;
       ...
       /// <param name="clipBounds"></param>
        ...
        internal void StartRippleAnimation(Point point, Brush rippleColor, double rippleAnimationDuration, float initialRippleFactor, bool fadeoutRipple,double width, double height)
        {
            isEffectsRenderer = true;
            this.effectsRendererWidth = width;
            this.effectsRendererHeight = height;
            this.StartRippleAnimation(point, rippleColor, rippleAnimationDuration, initialRippleFactor, fadeoutRipple);
            isEffectsRenderer = false;
        }
        ...
        private float GetFinalRadius(Point pivot)
        {
            ...
            {
                return (float)Math.Sqrt((this.effectsRendererWidth * this.effectsRendererWidth) + (this.effectsRendererHeight * this.effectsRendererHeight));
            }
