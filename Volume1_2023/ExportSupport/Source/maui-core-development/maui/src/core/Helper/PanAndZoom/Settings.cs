namespace Syncfusion.Maui.Core.Internals
{
    ...
    public class DoubleTapSettings
    {
        ...
        /// <summary>
        /// Gets or sets the percentage of the zoom that has to be increased, when a double tap occurs at the <see cref="Syncfusion.Maui.Core.Internals.DoubleTapSettings.DefaultZoomFactor"/>. 
