...
namespace Syncfusion.Maui.Core
{
    ...
    internal class NativeSnapLayout : LayoutViewGroup
    {
        ...
        public NativeSnapLayout(Context context)
            : base(context)
        {
            this.flingGestureListener = new FlingGestureListener();
            this.gestureDetector = new GestureDetector(this.Context, flingGestureListener);
        ...
        protected override void Dispose(bool disposing)
        {
            if (disposing)
            {
                ...
                {
                    this.flingGestureListener?.Dispose();
                    this.flingGestureListener = null;
                }
            }
        ...
        private void Handle_Touch(object? sender, TouchEventArgs touchEvent)
        {
            ...
            this.gestureDetector?.OnTouchEvent(touchEvent.Event);
            ...
            switch (touchEvent.Event.Action)
            {
                ...
                case MotionEventActions.PointerDown:
                    {
                        this.flingGestureListener!.Velocity = Point.Zero;
                        this.TouchEvent(point, "Down", this.flingGestureListener.Velocity);
                        break;
                    }

                case MotionEventActions.Move:
                    {
                        this.TouchEvent(point, "Move", this.flingGestureListener!.Velocity);
                        break;
                    }
                ...
                case MotionEventActions.PointerUp:
                    {
                        this.TouchEvent(point, "Up", this.flingGestureListener!.Velocity);
                        this.flingGestureListener.Velocity = Point.Zero;
                        break;
                    }
                ...
                case MotionEventActions.Cancel:
                    {
                        this.TouchEvent(point, "Cancel", this.flingGestureListener!.Velocity);
                        this.flingGestureListener.Velocity = Point.Zero;
                        break;
                    }
            }
        ...
        internal class FlingGestureListener : GestureDetector.SimpleOnGestureListener
        {
            ...
            {
                Func<double, double> fromPixels = Android.App.Application.Context.FromPixels;
                this.Velocity = new Point(fromPixels(velocityX), fromPixels(velocityY));
                return true;
            }
        }
    }
