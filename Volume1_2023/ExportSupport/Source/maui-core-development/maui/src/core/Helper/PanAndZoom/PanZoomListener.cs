...
namespace Syncfusion.Maui.Core.Internals
{
    ...
    /// </code>
    /// </example>
    public class PanZoomListener : IPinchGestureListener, IPanGestureListener, IDoubleTapGestureListener, ITouchListener, IKeyboardListener, INotifyPropertyChanged
    {
        ...
        #region Constructor
        /// <summary>
        /// Initializes a new instance of <see cref="Syncfusion.Maui.Core.Internals.PanZoomListener"/>
        /// </summary>
        ...
        {
            //Note: This method is empty for now and it added now because it is needed by ITouchListener interface.
        }
