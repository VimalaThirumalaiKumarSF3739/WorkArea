    ...
    internal class LegendLayout : AbsoluteLayout
    {
        ...
        private void CreateLegendView()
        {
            ...
            if (Legend != null)
            {
                ...
                legendItemsView = itemsView ?? new SfLegend();
                legendItemsView.ToggleVisibility = Legend.ToggleVisibility;
                legendItemsView.BindingContext = Legend;
                legendItemsView.SetBinding(SfLegend.ItemTemplateProperty, nameof(Legend.ItemTemplate));
                legendItemsView.SetBinding(SfLegend.ItemsLayoutProperty, nameof(Legend.ItemsLayout));
                legendItemsView.SetBinding(SfLegend.PlacementProperty, nameof(Legend.Placement));
                legendItemsView.ItemsSource = plotArea.LegendItems;
