...
namespace Syncfusion.Maui.Core.Internals
{
    ...
    public partial class GestureDetector : IDisposable
    {
        ...
        public void AddListener(IGestureListener listener)
        {
            ...
            // If dynamically call AddGestureListener mehtod or call after the MauiView's handler set, native listeners will be created in the below code. 
        ...
        /// <param name="velocity">Type of <see cref="Point"/></param>
        internal virtual void OnScroll(GestureStatus state, Point startPoint, Point scalePoint, Point velocity)
        {
            if (panGestureListeners != null)
            {
                PanEventArgs eventArgs = new PanEventArgs(state,startPoint, scalePoint, velocity);
